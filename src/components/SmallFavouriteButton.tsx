...
function SmallFavouriteButton({ onClick, isFavourite }: SmallFavoriteButtonProps) {
    return (
        <div
            onClick={onClick}
            className={`absolute w-[3.75rem] h-[3.75rem] bg-white rounded-[1.25rem] z-20 bg-no-repeat bg-center ${isFavourite ? 'bg-[url("../src/assets/fav-color-20.svg")]' : 'bg-[url("../src/assets/fav-20.svg")]'}
