...
function SortRevertButton({ onClick }: SortButtonProps) {
    return (
        <button
            onClick={onClick}
            className="flex items-center justify-center bg-center bg-no-repeat cursor-pointer ml-2 w-10 h-10 bg-stone-50 rounded-[10px] bg-[url('../src/assets/sort-revert-20.svg')]
