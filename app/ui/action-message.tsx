...
export default function ActionMessage({
  ...
  return (
    <div
      className="flex flex-shrink-0 flex-row items-center justify-between mb-3 px-4 py-4 w-[18.4375rem] h-[7.375rem] rounded-[0.625rem] bg-stone-50
        sm:w-[47rem] sm:h-[3.75rem]
        lg:w-[42.25rem]
        dark:bg-white dark:bg-opacity-5"
    >
      <div
        className="flex items-center justify-center w-[3.8125rem] h-[1.875rem] bg-white rounded-[0.3125rem]
            dark:bg-stone-900"
      >
        <div
          className="w-[2.5625rem] text-stone-900 text-base font-normal font-jost leading-normal 
                dark:text-white"
        >
          {dateOfEditing}
        </div>
