...
export default function UploadButton({
    ...
    return (
        <div
            ...
            onClick={onClick}
        >
            <div className={`w-4 h-4 mr-2 bg-no-repeat bg-center ${isHovered ? 'bg-[url("/upload-white-16.svg")]' : 'bg-[url("/upload-16.svg")]'}`} />
            <div className={`w-[3.5625rem] text-center text-rose-400 text-xs font-medium font-jost leading-none tracking-widest ${isHovered && 'text-white'}`}>
                UPLOAD
            </div>
        </div >
    );
