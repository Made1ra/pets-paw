export default function PetInfo({
  ...
  return (
    <div
      className="w-[40rem] h-fit rounded-[1.25rem] border-2 border-red-100 mt-6 p-2
        max-sm:w-[18.4375rem]
        sm:ml-14
        lg:ml-0
    ...
    >
      <div className="flex justify-center">
        <div
          className="w-fit text-stone-900 text-center text-4xl font-medium font-jost -mt-8 bg-white z-20
